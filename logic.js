window.onload = function () {
	...
	function disp1(sc){var cs =sc;$('#ref').removeAttr("disabled");$("#list1").css("display", "block"); for(o=0;o<=2;o++){ var lk = out[o]; $('#u'+o+'ser').html('<b>'+lk+'</b>');}$("#result").css("display", "block");$('#result').html('<b>you have scored: '+cs+'</b>');}
	function Myf(){
			for( i = 0 ; i <= 2; i++){
			if( uin[i] == out[i]){
						points.push("1");
	...
	$("#ref").click(function () {window.location.reload(true);
});
	$("#l").click(function () {
